        ...
        messages: [
          {
            ...
            content:
              ...
              "- '보복/불이익/신고 후'는 신고와 인사상 불이익의 인과관계가 핵심입니다.\n" +
              "- '불인정/미해당'는 해당 사유가 부인되거나 인정되지 않은 사건이 높습니다. 인정된 사건은 낮게 평가하세요.\n" +
              "- '양정과다/과중'은 비위는 인정되지만 징계 수위가 과하다고 본 사건이 높습니다.\n" +
              "- '사실상 해고/해고처럼'은 계약만료라도 실질적으로 해고 다툼인 사건이 높습니다.\n" +
              "- '여러 비위/복합 비위/정당성 전체'는 복수의 징계사유를 종합해서 사유, 양정, 절차를 함께 판단한 사건이 높습니다.\n\n" +
              '검색 결과:\n' +
