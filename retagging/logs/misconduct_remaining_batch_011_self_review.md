# misconduct_remaining_batch_011 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_011`
- reviewed 건수: 50
- 작업 기준:
...
- `id_15709`
  ...
  - secondary: ['misconduct', 'work_ability', 'evaluation', 'training_opportunity', 'disciplinary_severity']
