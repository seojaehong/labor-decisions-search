# misconduct_remaining_batch_010 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_010`
- reviewed 건수: 50
- 작업 기준:
...
- `id_15043`
  - reviewed primary/disposition: unfair_treatment / ['suspension', 'reprimand', 'demotion']
  - secondary: ['misconduct', 'procedure', 'disciplinary_severity']
