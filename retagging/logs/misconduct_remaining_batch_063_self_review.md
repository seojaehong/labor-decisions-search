# misconduct_remaining_batch_063 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_063`
- reviewed 건수: 50
- 작업 기준:
...
- `id_3821`
  ...
  - exclusion_flags: ['not_really_absence_case', 'resignation_dispute', 'evidence_too_thin']
  - 변경 이유: 비위 언급은 있으나 실질은 해고 존부/사직·합의해지 효력 판단 사건
- `id_38277`
  - reviewed primary/disposition: procedure / ['dismissal']
  - secondary: ['absence_without_leave', 'misconduct', 'disciplinary_severity']
  - exclusion_flags: ['not_really_absence_case', 'procedure_dominant', 'evidence_too_thin']
...
- `id_3831`
  ...
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_38397`
  - reviewed primary/disposition: procedure / ['demotion']
