# misconduct_remaining_batch_041 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_041`
- reviewed 건수: 50
- 작업 기준:
...
- `id_33639`
  ...
  - secondary: ['absence_without_leave', 'misconduct', 'training_opportunity', 'disciplinary_severity']
