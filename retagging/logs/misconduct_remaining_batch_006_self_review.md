# misconduct_remaining_batch_006 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_006`
- reviewed 건수: 50
- 작업 기준:
...
- `id_12575`
  ...
  - secondary: ['misconduct', 'performance', 'procedure', 'disciplinary_severity']
...
- `id_12643`
  - reviewed primary/disposition: procedure / ['suspension', 'pay_cut', 'reprimand']
  - secondary: ['misconduct', 'disciplinary_severity']
