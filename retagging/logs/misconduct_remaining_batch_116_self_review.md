# misconduct_remaining_batch_116 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_116`
- reviewed 건수: 50
- 작업 기준:
...
- `id_49591`
  ...
  - secondary: ['misconduct', 'disciplinary_severity', 'harassment_report']
...
- `id_49603`
  - reviewed primary/disposition: procedure / ['dismissal']
  - secondary: ['misconduct', 'performance', 'disciplinary_severity', 'transfer_validity']
  - exclusion_flags: ['procedure_dominant']
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_49663`
  - reviewed primary/disposition: procedure / ['dismissal']
