# misconduct_remaining_batch_031 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_031`
- reviewed 건수: 50
- 작업 기준:
...
- `id_27297`
  ...
  - secondary: ['misconduct', 'evaluation', 'procedure', 'disciplinary_severity', 'transfer_validity']
