# misconduct_remaining_batch_118 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_118`
- reviewed 건수: 50
- 작업 기준:
...
- `id_50397`
  ...
  - secondary: ['attendance', 'absence_without_leave', 'misconduct', 'procedure', 'disciplinary_severity']
