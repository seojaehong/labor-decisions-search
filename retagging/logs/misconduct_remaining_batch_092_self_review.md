# misconduct_remaining_batch_092 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_092`
- reviewed 건수: 50
- 작업 기준:
...
- `id_412187`
  ...
  - exclusion_flags: ['not_really_absence_case', 'resignation_dispute', 'procedure_dominant', 'unrelated_to_dismissal']
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
