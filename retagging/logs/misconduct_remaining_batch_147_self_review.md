# misconduct_remaining_batch_147 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_147`
- reviewed 건수: 50
- 작업 기준:
...
- `id_6919`
  ...
  - secondary: ['misconduct', 'evaluation', 'procedure', 'worker_status', 'transfer_validity']
  - exclusion_flags: []
