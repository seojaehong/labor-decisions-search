# misconduct_remaining_batch_138 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_138`
- reviewed 건수: 50
- 작업 기준:
...
- `id_58735`
  ...
  - secondary: ['misconduct', 'training_opportunity', 'disciplinary_severity', 'unfair_treatment']
  - exclusion_flags: ['procedure_dominant']
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_58777`
  - reviewed primary/disposition: workplace_harassment / ['demotion']
