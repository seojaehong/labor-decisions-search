# misconduct_remaining_batch_005 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_005`
- reviewed 건수: 50
- 작업 기준:
...
- `id_12233`
  ...
  - secondary: ['misconduct', 'worker_status', 'disciplinary_severity']
  - exclusion_flags: ['procedure_dominant']
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_12239`
...
- `id_12257`
  ...
  - secondary: ['misconduct', 'performance', 'procedure', 'training_opportunity', 'disciplinary_severity']
  - exclusion_flags: ['unrelated_to_dismissal']
  - 변경 이유: misconduct보다 부당노동행위 판단이 중심이어서 unfair_treatment로 정리
