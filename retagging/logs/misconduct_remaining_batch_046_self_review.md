# misconduct_remaining_batch_046 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_046`
- reviewed 건수: 50
- 작업 기준:
...
- `id_345941`
  ...
  - secondary: ['attendance', 'misconduct', 'procedure', 'disciplinary_severity', 'transfer_validity']
