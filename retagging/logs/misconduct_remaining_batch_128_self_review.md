# misconduct_remaining_batch_128 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_128`
- reviewed 건수: 50
- 작업 기준:
...
- `id_54453`
  - reviewed primary/disposition: workplace_harassment / ['suspension', 'pay_cut']
...
- `id_54463`
  ...
  - 변경 이유: 반복성·지위이용 구조상 단순 비위보다 괴롭힘 성격이 두드러져 workplace_harassment 선택
- `id_54473`
  - reviewed primary/disposition: workplace_harassment / ['suspension', 'demotion']
