# misconduct_remaining_batch_023 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_023`
- reviewed 건수: 50
- 작업 기준:
...
- `id_22319`
  ...
  - secondary: ['procedure']
  - exclusion_flags: ['settlement_or_mutual_termination', 'resignation_dispute', 'evidence_too_thin']
