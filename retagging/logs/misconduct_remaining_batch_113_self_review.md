# misconduct_remaining_batch_113 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_113`
- reviewed 건수: 50
- 작업 기준:
...
- `id_48415`
  ...
  - secondary: ['misconduct', 'disciplinary_severity', 'transfer_validity', 'unfair_treatment']
  - exclusion_flags: ['unrelated_to_dismissal']
  - 변경 이유: 반복성·지위이용 구조상 단순 비위보다 괴롭힘 성격이 두드러져 workplace_harassment 선택
