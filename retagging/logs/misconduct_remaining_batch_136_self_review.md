# misconduct_remaining_batch_136 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_136`
- reviewed 건수: 50
- 작업 기준:
...
- `id_57901`
  ...
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_57961`
  - reviewed primary/disposition: disciplinary_severity / ['suspension', 'reprimand']
...
- `id_57993`
  ...
  - secondary: ['misconduct', 'procedure', 'worker_status', 'disciplinary_severity']
  - exclusion_flags: []
