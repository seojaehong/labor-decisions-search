# misconduct_remaining_batch_114 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_114`
- reviewed 건수: 50
- 작업 기준:
...
- `id_48769`
  - reviewed primary/disposition: workplace_harassment / ['suspension', 'reprimand']
...
- `id_48791`
  ...
  - secondary: ['misconduct', 'procedure', 'training_opportunity', 'unfair_treatment']
  - exclusion_flags: ['unrelated_to_dismissal']
  - 변경 이유: 반복성·지위이용 구조상 단순 비위보다 괴롭힘 성격이 두드러져 workplace_harassment 선택
- `id_48799`
