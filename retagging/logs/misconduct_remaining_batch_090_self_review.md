# misconduct_remaining_batch_090 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_090`
- reviewed 건수: 50
- 작업 기준:
...
- `id_411205`
  ...
  - secondary: ['misconduct', 'evaluation', 'training_opportunity', 'disciplinary_severity']
...
- `id_411331`
  ...
  - exclusion_flags: []
  - 변경 이유: 비위행위의 존재 및 중대성이 해고 정당성을 직접 좌우하는 사례
