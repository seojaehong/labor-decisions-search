# misconduct_remaining_batch_059 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_059`
- reviewed 건수: 50
- 작업 기준:
...
- `id_36395`
  ...
  - secondary: ['attendance', 'absence_without_leave', 'misconduct', 'training_opportunity', 'disciplinary_severity']
