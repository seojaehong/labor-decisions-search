# misconduct_remaining_batch_085 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_085`
- reviewed 건수: 50
- 작업 기준:
...
- `id_408827`
  - reviewed primary/disposition: disciplinary_severity / ['dismissal']
  - secondary: ['attendance', 'absence_without_leave', 'misconduct']
  - exclusion_flags: []
  - 변경 이유: 비위사실 자체보다 제재 수위가 결론을 좌우해 disciplinary_severity를 primary로 선택
- `id_408847`
  - reviewed primary/disposition: dismissal_validity / ['rejection_of_regular_employment']
  - secondary: ['attendance', 'misconduct', 'evaluation', 'procedure', 'worker_status']
  - exclusion_flags: []
