# misconduct_remaining_batch_117 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_117`
- reviewed 건수: 50
- 작업 기준:
...
- `id_50057`
  ...
  - exclusion_flags: ['procedure_dominant', 'evidence_too_thin']
...
- `id_50107`
  ...
  - secondary: ['attendance', 'misconduct', 'disciplinary_severity']
  - exclusion_flags: ['procedure_dominant', 'unrelated_to_dismissal']
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_50133`
  - reviewed primary/disposition: workplace_harassment / ['suspension']
  - secondary: ['misconduct', 'procedure', 'training_opportunity', 'disciplinary_severity', 'harassment_report']
  - exclusion_flags: ['unrelated_to_dismissal']
...
- `id_50163`
  ...
  - secondary: ['absence_without_leave', 'misconduct', 'procedure']
