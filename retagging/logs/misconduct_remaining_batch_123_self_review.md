# misconduct_remaining_batch_123 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_123`
- reviewed 건수: 50
- 작업 기준:
...
- `id_52479`
  ...
  - secondary: ['misconduct', 'procedure', 'disciplinary_severity', 'harassment_report']
...
- `id_52511`
  ...
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_52513`
  - reviewed primary/disposition: workplace_harassment / ['pay_cut', 'reprimand']
