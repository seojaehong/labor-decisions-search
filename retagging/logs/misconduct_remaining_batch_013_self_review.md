# misconduct_remaining_batch_013 self-review

## 1. batch 개요
- batch: `misconduct_remaining_batch_013`
- reviewed 건수: 50
- 작업 기준:
...
- `id_16877`
  ...
  - 변경 이유: 실체 사유보다 서면통지·소명기회 등 절차 하자가 결론을 좌우한 사례
- `id_16899`
  - reviewed primary/disposition: unfair_treatment / ['suspension', 'pay_cut', 'reprimand']
